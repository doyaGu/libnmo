...
nmo_status_t nmo_reference_resolver_register_strategy(
    nmo_reference_resolver_t *resolver,
    nmo_class_id_t class_id,
...
nmo_status_t nmo_reference_resolver_resolve_all(
    nmo_reference_resolver_t *resolver
) {
    if (!resolver) {
        return NMO_ERR_INVALID_ARGUMENT;
...
nmo_status_t nmo_reference_resolver_get_stats(
...
nmo_status_t nmo_reference_resolver_get_unresolved(
    const nmo_reference_resolver_t *resolver,
