...
static const nmo_type_field_t fields_body[] = {
    ...
    NMO_FIELD_PTR_ARRAY(nmo_interface_body_t, links,      NMO_GUID_IFACE_LINK),
    NMO_FIELD_PTR_ARRAY(nmo_interface_body_t, operations, NMO_GUID_IFACE_OPERATION),
    NMO_FIELD_PTR_ARRAY(nmo_interface_body_t, comments,   NMO_GUID_IFACE_COMMENT),
...
static const nmo_type_field_t fields_data[] = {
    ...
    NMO_FIELD_PTR_ARRAY(nmo_interface_data_t, subs, NMO_GUID_IFACE_BEHAVIOR),
