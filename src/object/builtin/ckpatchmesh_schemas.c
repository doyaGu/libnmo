...
static const nmo_type_field_t nmo_patchmesh_fields[] = {
    ...
    NMO_FIELD_REF_ARRAY_COUNTED(nmo_patchmesh_state_t, patch_material_ids, patch_count),
    NMO_FIELD_ARRAY_COUNTED(nmo_patchmesh_state_t, patches, patch_count, 1, NMO_GUID_STRUCT_CKPATCHMESHPATCH),
    ...
    NMO_FIELD_REF_ARRAY_COUNTED(nmo_patchmesh_state_t, legacy_material_ids, legacy_material_count)
};
