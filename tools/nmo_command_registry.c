...
static void debug_probe_usage(FILE *out) {
    fprintf(out, "Usage: nmo debug probe 2d-text|console|debug-output|control-marker --behavior <id> [--from-io <id>] [--to-io <id>] [--name <name>] [--text <text>] [--dry-run] <file> -o <output>\n\n");
