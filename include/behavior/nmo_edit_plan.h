...
typedef struct nmo_edit_changed_object {
    ...
    bool has_interface_before;
    nmo_object_id_t before_interface_behavior_id;
    bool before_has_interface;
    bool before_has_interface_chunk;
    bool before_has_interface_data;
    bool before_interface_ids_are_runtime;
    uint32_t before_interface_version;
    uint32_t before_interface_sub_count;
    bool has_interface_after;
    nmo_object_id_t after_interface_behavior_id;
    bool after_has_interface;
    bool after_has_interface_chunk;
    bool after_has_interface_data;
    bool after_interface_ids_are_runtime;
    uint32_t after_interface_version;
    uint32_t after_interface_sub_count;
    bool has_data_cell_before;
    uint32_t before_data_cell_row;
    uint32_t before_data_cell_col;
    uint32_t before_data_cell_type;
    char before_data_cell_value[64];
    bool has_data_cell_after;
    uint32_t after_data_cell_row;
    ...
    nmo_manager_entry_schema_t before_manager_entry_schema;
    char before_manager_entry_key[128];
    char before_manager_entry_category[128];
    nmo_guid_t before_manager_entry_type_guid;
    uint32_t before_manager_entry_index;
    uint32_t before_manager_entry_value;
    uint32_t before_manager_entry_compatible_class_id;
    uint32_t before_manager_entry_flags;
    ...
    nmo_manager_entry_schema_t after_manager_entry_schema;
    char after_manager_entry_key[128];
    char after_manager_entry_category[128];
    nmo_guid_t after_manager_entry_type_guid;
    uint32_t after_manager_entry_index;
    uint32_t after_manager_entry_value;
    uint32_t after_manager_entry_compatible_class_id;
    uint32_t after_manager_entry_flags;
