 ...
 */
typedef void (*nmo_log_fn)(void *user_data, nmo_log_level_t level, const char *message);
...
typedef struct nmo_logger {
    ...
    nmo_log_level_t level; /**< Minimum log level */
} nmo_logger_t;
 ...
 */
NMO_API nmo_logger_t nmo_logger_stderr(void);
 ...
 * @return Null logger
 */
NMO_API nmo_logger_t nmo_logger_null(void);
 ...
 */
NMO_API nmo_logger_t nmo_logger_custom(nmo_log_fn log, void *user_data, nmo_log_level_t level);
 ...
 */
NMO_API void nmo_log(nmo_logger_t *logger, nmo_log_level_t level, const char *format, ...);
 ...
 */
NMO_API void nmo_vlog(nmo_logger_t *logger, nmo_log_level_t level, const char *format, va_list args);
