...
typedef struct nmo_error nmo_error;
 ...
 */
struct nmo_error {
    nmo_error_code    code;      /**< Error code */
    nmo_severity      severity;  /**< Severity level */
    const char*       message;   /**< Error message */
    const char*       file;      /**< Source file (for debugging) */
    int               line;      /**< Source line (for debugging) */
    nmo_error*        cause;     /**< Causal error (chain) */
};
...
typedef struct nmo_result {
    nmo_error_code  code;   /**< Error code */
    nmo_error*      error;  /**< Detailed error info (NULL if OK) */
} nmo_result;

/**
 * @brief Typedef for result structure
 */
typedef nmo_result nmo_result_t;
 ...
 */
NMO_API nmo_error* nmo_error_create(nmo_arena* arena,
                                     nmo_error_code code,
 ...
 */
NMO_API void nmo_error_add_cause(nmo_error* error, nmo_error* cause);
 ...
 */
NMO_API const char* nmo_error_string(nmo_error_code code);
 ...
 */
NMO_API nmo_result nmo_result_ok(void);
 ...
 * @return Error result
 */
NMO_API nmo_result nmo_result_error(nmo_error* error);
