...
typedef enum nmo_type_vtable_source {
    ...
    NMO_TYPE_VTABLE_SOURCE_EXPLICIT = 1,
    NMO_TYPE_VTABLE_SOURCE_BASE_DEFAULT = 2,
    NMO_TYPE_VTABLE_SOURCE_CATEGORY_DEFAULT = 3,
    NMO_TYPE_VTABLE_SOURCE_METADATA_DEFAULT = 4,
    NMO_TYPE_VTABLE_SOURCE_MERGED_DEFAULT = 5
