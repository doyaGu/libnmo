...
/**
 * @brief Start object ID sequence
 *
 ...
 * @return NMO_OK on success, error code on failure
 */
NMO_API nmo_result_t nmo_chunk_start_object_sequence(nmo_chunk_t *chunk, size_t count);

/**
 * @brief Write object ID in sequence
 *
 * Must be called after StartObjectSequence.
 * Note: This function writes a SINGLE object ID within a sequence.
 *
 * @param chunk Chunk (required)
 * @param id Object ID
 * @return NMO_OK on success, error code on failure
 */
NMO_API nmo_result_t nmo_chunk_sequence_write_object_id(nmo_chunk_t *chunk, nmo_object_id_t id);

/**
 * @brief Write object ID in sequence (deprecated alias)
 * @deprecated Use nmo_chunk_sequence_write_object_id() instead for clarity
 */
NMO_API nmo_result_t nmo_chunk_write_object_id_sequence(nmo_chunk_t *chunk, nmo_object_id_t id);
 ...
 * @return NMO_OK on success, error code on failure
 */
NMO_API nmo_result_t nmo_chunk_start_read_sequence(nmo_chunk_t *chunk, size_t *out_count);
