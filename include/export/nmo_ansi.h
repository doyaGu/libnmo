...
#ifndef NMO_EXPORT_ANSI_H
#define NMO_EXPORT_ANSI_H

#define NMO_ANSI_PUBLIC_HEADER_KIND NMO_PUBLIC_HEADER_KIND_SINGLE_TIER
#define NMO_ANSI_API_TIER NMO_API_TIER_ADVANCED_C
