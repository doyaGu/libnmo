...
typedef enum ProcessorsFeatures {
    PROC_HASFPU = 0x00000001,
    PROC_V86 = 0x00000002,
    PROC_DE = 0x00000004,
    PROC_PSE = 0x00000008,
    PROC_TIMESTAMP = 0x00000010,
    PROC_MSR = 0x00000020,
    PROC_PAE = 0x00000040,
    PROC_MCE = 0x00000080,
    PROC_CMPXCHG8B = 0x00000100,
    PROC_APIC = 0x00000200,
    PROC_RESERVED = 0x00000400,
    PROC_SEP = 0x00000800,
    PROC_MTRR = 0x00001000,
    PROC_PGE = 0x00002000,
    PROC_MCA = 0x00004000,
    PROC_CMOV = 0x00008000,
    PROC_PAT = 0x00010000,
    PROC_PST32 = 0x00020000,
    PROC_PN = 0x00040000,
    PROC_MMX = 0x00800000,
    PROC_FXSR = 0x01000000,
    PROC_SIMD = 0x02000000,
    PROC_WNI = 0x04000000,
    PROC_SS = 0x08000000,
    PROC_HTT = 0x10000000,
    PROC_TM = 0x20000000
...
typedef enum InstructionSetExtensions {
    ISEX_NONE = 0x00000000,
    ISEX_SSE = 0x00000001,
    ISEX_SSE2 = 0x00000002,
    ISEX_SSE3 = 0x00000004,
    ISEX_SSSE3 = 0x00000008,
    ISEX_SSE41 = 0x00000010,
    ISEX_SSE42 = 0x00000020,
    ISEX_AVX = 0x00000040,
    ISEX_AVX2 = 0x00000080,
    ISEX_FMA3 = 0x00000100,
    ISEX_BMI1 = 0x00000200,
    ISEX_BMI2 = 0x00000400,
    ISEX_AVX512F = 0x00000800,
    ISEX_AVX512DQ = 0x00001000,
    ISEX_AVX512BW = 0x00002000,
    ISEX_AVX512VL = 0x00004000,
    ISEX_AVX512VNNI = 0x00008000,
    ISEX_AVX512CD = 0x00010000
