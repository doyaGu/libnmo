/**
 * @file nmo_interfaceobjectmanager_schemas.h
 ...
 */
typedef struct nmo_interfaceobjectmanager_state {
...
NMO_API nmo_status_t nmo_interfaceobjectmanager_serialize(
    const void *instance,
    nmo_chunk_t *out_chunk,
    const nmo_type_descriptor_t *type,
    void *context);

NMO_API nmo_status_t nmo_interfaceobjectmanager_prepare_dependencies(
    void *instance,
    const nmo_type_descriptor_t *type,
    void *context);

NMO_API nmo_status_t nmo_interfaceobjectmanager_remap_dependencies(
    void *instance,
    const nmo_type_descriptor_t *type,
    void *context);

NMO_DECLARE_OBJECT_SCHEMA(nmo_interfaceobjectmanager_vtable, nmo_register_interfaceobjectmanager_type)
