 ...
 * Size: ~200 bytes
 */
typedef struct nmo_material_state {
    ...
    uint8_t material_data_is_legacy;
    uint8_t has_effect;
...
NMO_API nmo_status_t nmo_material_deserialize(
    void *instance,
    nmo_chunk_t *chunk,
    const nmo_type_descriptor_t *type,
    void *context);

NMO_API nmo_status_t nmo_material_serialize(
    const void *instance,
