/**
 * @file nmo_document_perf_stats.h
 * @brief Phase-level load/save performance statistics
 */

#ifndef NMO_DOCUMENT_PERF_STATS_H
#define NMO_DOCUMENT_PERF_STATS_H
...
#define NMO_DOCUMENT_PERF_STATS_PUBLIC_HEADER_KIND NMO_PUBLIC_HEADER_KIND_SINGLE_TIER
#define NMO_DOCUMENT_PERF_STATS_API_TIER NMO_API_TIER_ADVANCED_C
...
#endif /* NMO_DOCUMENT_PERF_STATS_H */
