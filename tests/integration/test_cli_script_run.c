...
TEST(cli, script_run_executor_set_parameter_value_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_set_parameter_value.lua",
        script_path,
        sizeof(script_path)));
    ...
    ASSERT_EQ(5u, get_uint_field(op, "primary_id"));
    changed_objects = get_array_field(data, "changed_objects");
    ASSERT_NOT_NULL(changed_objects);
    ASSERT_EQ(1u, yyjson_arr_size(changed_objects));
    changed = yyjson_arr_get(changed_objects, 0);
    ASSERT_EQ(5u, get_uint_field(changed, "object_id"));
    ASSERT_STR_EQ("set_parameter_value", get_string_field(changed, "cause"));
    yyjson_doc_free(doc);
}
...
TEST(cli, script_run_executor_set_parameter_bytes_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_set_parameter_bytes.lua",
        script_path,
        sizeof(script_path)));
    ...
    ASSERT_EQ(64u, get_uint_field(op, "primary_id"));
    changed_objects = get_array_field(data, "changed_objects");
    ASSERT_NOT_NULL(changed_objects);
    ASSERT_EQ(1u, yyjson_arr_size(changed_objects));
    changed = yyjson_arr_get(changed_objects, 0);
    ASSERT_EQ(64u, get_uint_field(changed, "object_id"));
    ASSERT_STR_EQ("set_parameter_bytes", get_string_field(changed, "cause"));
    yyjson_doc_free(doc);
}
...
TEST(cli, script_run_executor_set_parameter_value_to_handle_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_set_parameter_value_to_handle.lua",
        script_path,
        sizeof(script_path)));
...
TEST(cli, script_run_executor_set_parameter_bytes_to_handle_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_set_parameter_bytes_to_handle.lua",
        script_path,
        sizeof(script_path)));
...
TEST(cli, script_run_executor_add_behavior_link_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_add_behavior_link.lua",
        script_path,
        sizeof(script_path)));
    ...
    ASSERT_STR_EQ("add_behavior_link", get_string_field(created, "cause"));
    yyjson_doc_free(doc);
}
...
TEST(cli, script_run_executor_add_parameter_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_add_parameter.lua",
        script_path,
        sizeof(script_path)));
    ...
    ASSERT_EQ(1u, yyjson_arr_size(created_objects));
    created = yyjson_arr_get(created_objects, 0);
    ASSERT_STR_EQ("add_parameter", get_string_field(created, "cause"));
    yyjson_doc_free(doc);
}
...
TEST(cli, script_run_executor_add_operation_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_add_operation.lua",
        script_path,
        sizeof(script_path)));
...
TEST(cli, script_run_executor_rename_io_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_rename_io.lua",
        script_path,
        sizeof(script_path)));
    ...
    ASSERT_EQ(2u, get_uint_field(op, "primary_id"));
    changed_objects = get_array_field(data, "changed_objects");
    ASSERT_NOT_NULL(changed_objects);
    ASSERT_EQ(1u, yyjson_arr_size(changed_objects));
    changed = yyjson_arr_get(changed_objects, 0);
    ASSERT_EQ(2u, get_uint_field(changed, "object_id"));
    ASSERT_STR_EQ("rename_io", get_string_field(changed, "cause"));
    yyjson_doc_free(doc);
}
...
TEST(cli, script_run_executor_add_node_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_add_node.lua",
        script_path,
        sizeof(script_path)));
    ...
    op = yyjson_arr_get(operations, 0);
    ASSERT_STR_EQ("add_node", get_string_field(op, "op"));
    ASSERT_EQ(3u, get_uint_field(op, "primary_id"));
    ASSERT_TRUE(get_uint_field(op, "result_id") != 0u);
    created_objects = get_array_field(data, "created_objects");
    ASSERT_NOT_NULL(created_objects);
...
TEST(cli, script_run_executor_add_node_accepts_manager_entry_policy) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_add_node_manager_policy.lua",
        script_path,
        sizeof(script_path)));
...
TEST(cli, script_run_executor_replace_bb_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_replace_bb.lua",
        script_path,
        sizeof(script_path)));
    ...
    ASSERT_EQ(343u, get_uint_field(op, "primary_id"));
    ASSERT_EQ(343u, get_uint_field(op, "result_id"));
    changed_objects = get_array_field(data, "changed_objects");
    ASSERT_NOT_NULL(changed_objects);
    ASSERT_EQ(1u, yyjson_arr_size(changed_objects));
    ASSERT_STR_EQ("replace_bb",
                  get_string_field(yyjson_arr_get(changed_objects, 0),
                                   "cause"));
    yyjson_doc_free(doc);
}
...
TEST(cli, script_run_executor_fold_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_fold.lua",
        script_path,
        sizeof(script_path)));
    ...
    ASSERT_EQ(2367u, get_uint_field(op, "result_id"));
    changed_objects = get_array_field(data, "changed_objects");
    ASSERT_NOT_NULL(changed_objects);
    ASSERT_TRUE(yyjson_arr_size(changed_objects) >= 1u);
    yyjson_doc_free(doc);
}
...
TEST(cli, script_run_executor_rewire_behavior_link_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_rewire_behavior_link.lua",
        script_path,
        sizeof(script_path)));
...
TEST(cli, script_run_executor_set_behavior_link_delay_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_set_behavior_link_delay.lua",
        script_path,
        sizeof(script_path)));
...
TEST(cli, script_run_executor_remove_behavior_link_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_remove_behavior_link.lua",
        script_path,
        sizeof(script_path)));
    ...
    ASSERT_EQ(79u, get_uint_field(op, "primary_id"));
...
TEST(cli, script_run_executor_connect_parameter_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_connect_parameter.lua",
        script_path,
        sizeof(script_path)));
...
TEST(cli, script_run_executor_connect_parameter_to_handle_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_connect_parameter_to_handle.lua",
        script_path,
        sizeof(script_path)));
...
TEST(cli, script_run_executor_disconnect_parameter_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_disconnect_parameter.lua",
        script_path,
        sizeof(script_path)));
...
TEST(cli, script_run_executor_remove_parameter_uses_edit_plan) {
    ...
    ASSERT_TRUE(build_repo_fixture_path(
        "tests/fixtures/lua/script_run_remove_parameter.lua",
        script_path,
        sizeof(script_path)));
    ...
    ASSERT_EQ(18u, get_uint_field(op, "primary_id"));
    deleted_objects = get_array_field(data, "deleted_objects");
    ASSERT_NOT_NULL(deleted_objects);
    ASSERT_EQ(1u, yyjson_arr_size(deleted_objects));
    ASSERT_EQ(18u, get_uint_field(yyjson_arr_get(deleted_objects, 0), "object_id"));
    yyjson_doc_free(doc);
}
...
TEST(cli, script_run_reports_executor_operations) {
    ...
    ASSERT_TRUE(build_repo_fixture_path("tests/fixtures/lua/script_run_canonicalize_io.lua",
                                        script_path,
                                        sizeof(script_path)));
    ...
    ASSERT_NOT_NULL(operations);
    ASSERT_EQ(2u, yyjson_arr_size(operations));
    ASSERT_STR_EQ("remove_io", get_string_field(yyjson_arr_get(operations, 0), "op"));
    ASSERT_STR_EQ("interface_policy", get_string_field(yyjson_arr_get(operations, 1), "op"));
    yyjson_doc_free(doc);
}
...
TEST_MAIN_BEGIN()
    ...
    REGISTER_TEST(cli, script_run_executor_set_parameter_bytes_uses_edit_plan);
    REGISTER_TEST(cli, script_run_executor_set_parameter_value_to_handle_uses_edit_plan);
    ...
    REGISTER_TEST(cli, script_run_executor_connect_parameter_to_handle_uses_edit_plan);
